...
<body>
    <section>
        ...
        <form action="{{ route('product.update', ['product'=>$product]) }}" method="post">
            ...
            <div>
                <input type="number" name="qty" placeholder="Enter Product Qty" value="{{ $product->qty }}">
            </div>
            <div>
                <input type="number" name="price" placeholder="Enter Product Price" value="{{ $product->price }}">
            </div>
            <div>
                <input type="text" name="description" placeholder="Enter Product Descritpion" value="{{ $product->descritpion }}">
            </div>
            <div>
